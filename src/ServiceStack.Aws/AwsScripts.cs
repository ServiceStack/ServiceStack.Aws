...
namespace ServiceStack.Aws
{
    ...
    public class AwsScripts : ScriptMethods
    {
        ...
        public S3VirtualFiles s3VirtualFiles(AmazonS3Client s3Client, string bucketName) => 
            new S3VirtualFiles(s3Client, bucketName);

        public S3VirtualFiles s3VirtualFiles(string awsAccessKeyId, string awsSecretAccessKey, string region, string bucketName) => 
