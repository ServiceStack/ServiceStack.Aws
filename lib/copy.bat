...
REM COPY C:\src\ServiceStack.Aws\src\ServiceStack.Aws\bin\Release\ServiceStack.Aws.* .
COPY C:\src\ServiceStack.Aws\src\ServiceStack.Aws\bin\Debug\ServiceStack.Aws.* .
